                            ...
                            <div class="basic-form">
                                <form method="POST" action="project_insert.php" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>Choose Two Images <span class="text-primary">(Resolution:1920 ×
                                                    1080)</span></label>
                                    ...
                                    <div class="form-row">
                                         <div class="form-group col-md-6">
                                            <label>Choose Multiple Images <span class="text-primary">(Resolution:600 ×
                                                    900)</span></label>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>Choose Four Images <span class="text-primary">(Resolution:1920 ×
                                                    1080)</span></label>
